...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      verifyEligibility: (...args_1) => {
        ...
        const claimedEligible_0 = args_1[1];
        const eligibilityScore_0 = args_1[2];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('verifyEligibility',
                                     'argument 1 (as invoked from Typescript)',
                                     'shadow-pass.compact line 51 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        if (!(typeof(claimedEligible_0) === 'boolean')) {
          __compactRuntime.typeError('verifyEligibility',
        ...
        if (!(typeof(eligibilityScore_0) === 'bigint' && eligibilityScore_0 >= 0n && eligibilityScore_0 <= 18446744073709551615n)) {
          __compactRuntime.typeError('verifyEligibility',
        ...
        const partialProofData = {
          input: {
            value: _descriptor_2.toValue(claimedEligible_0).concat(_descriptor_1.toValue(eligibilityScore_0)),
  ...
  initialState(...args_0) {
    ...
    __compactRuntime.queryLedgerState(context,
                                      ...
                                      [
                                       ...
                                       { ins: { cached: false, n: 1 } }]);
    const MIN_ELIGIBILITY_SCORE_0 = 60n;
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_7.toValue(0n),
                                                                                              alignment: _descriptor_7.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_1.toValue(MIN_ELIGIBILITY_SCORE_0),
                                                                                              alignment: _descriptor_1.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } }]);
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
  ...
  _verifyEligibility_0(context,
                       ...
                       eligibilityScore_0)
  {
    if (claimedEligible_0) {
      __compactRuntime.assert(eligibilityScore_0
                              >=
                              ...
                              'Not eligible: private value is below the requirement');
    } else {
      __compactRuntime.assert(eligibilityScore_0
                              <
                              _descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                        ...
                                                                                        [
                                                                                         ...
                                                                                         { popeq: { cached: false,
                                                                                                    result: undefined } }]).value),
                              'Not ineligible: private value is at least the requirement');
    }
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_7.toValue(2n),
                                                                                              alignment: _descriptor_7.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_2.toValue(claimedEligible_0),
                                                                                              alignment: _descriptor_2.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } }]);
    const tmp_0 = 1n;
    __compactRuntime.queryLedgerState(context,
